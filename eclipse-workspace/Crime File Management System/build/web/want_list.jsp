<%-- 
    Document   : want_list
    Created on : Jan 11, 2017, 10:34:27 AM
    Author     : java4
--%>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <div class="menu-wrapper">
            <div class="menu">
                 <ul>
                    ...
                    <li><a href="want_list.jsp" class="active">Wanted Add</a></li>
        ...
        <div id="contentinfo">
            <!--==============================body start=================================-->
            <br><br><center><h2 style="font-size: 26px; color: #ffffff; font-family: cursive">ADDED MOST WANTED DETAILS</h2>
                        <br><form action="MostWanted" method="post"  enctype="multipart/form-data"> 
                                <table>
                                    <tr>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" class="inputs" name="wight" required="" placeholder="Wight" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
