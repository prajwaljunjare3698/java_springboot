<%-- 
    Document   : com
    Created on : Jan 10, 2017, 4:52:10 PM
    Author     : java4
--%>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <div id="contentinfo">
            <!--==============================body start=================================-->
            <br><br><center><h2 style="font-size: 26px; color: #ffffff; font-family: cursive">Complaint</h2>
                        <br><form action="login.jsp" method="get"> 
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" class="inputs" name="d_suspect" required="" placeholder="Your Name" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
