<%-- 
    Document   : fir_insert
    Created on : Jan 10, 2017, 8:07:04 PM
    Author     : java4
--%>
...
<%
    ...
    System.out.println("FIR Details :" + mname + mplace + misdate + age + wight + height + addomiss + dateofreport + firno + act);

    int i = st.executeUpdate("insert into fir(mname, mplace, misdate, age, wight, height, addomiss, dateofreport, firno, act) values ('" + mname + "','" + mplace + "','" + misdate + "','" + age + "','" + wight + "','" + height + "','" + addomiss + "','" + dateofreport + "','" + firno + "','" + act + "')");
    if (i != 0) {
